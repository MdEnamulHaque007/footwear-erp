/// ============================================================================
/// ফাইল: lib/data/datasources/remote/auth_remote_datasource.dart
/// স্তর: Data Source | মডিউল: Authentication
/// উদ্দেশ্য: Authentication মডিউলের Firebase বা local data source-এর সরাসরি যোগাযোগ পরিচালনা করে।
/// প্রধান অংশ: AuthRemoteDataSource, ProfileMissingException, ProfileUnavailableException
