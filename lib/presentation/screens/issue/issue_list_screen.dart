/// ============================================================================
/// ফাইল: lib/presentation/screens/issue/issue_list_screen.dart
...
/// প্রধান অংশ: IssueListScreen, _IssueListScreenState, _IssueSearchDelegate
...
class _IssueListScreenState extends State<IssueListScreen> {
  ...
  Widget _totalQuantityBadge() => BlocBuilder<IssueBloc, IssueState>(
    buildWhen: (_, state) => state is IssueLoaded,
    builder: (context, state) {
      final total = state is IssueLoaded
          ? state.items
                .where(_matches)
