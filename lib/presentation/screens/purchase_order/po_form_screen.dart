/// ============================================================================
/// ফাইল: lib/presentation/screens/purchase_order/po_form_screen.dart
...
/// প্রধান অংশ: POFormScreen, _POFormScreenState, _LineItemControllers
...
class _POFormScreenState extends State<POFormScreen> {
  ...
  void _save() {
    ...
    final item = POEntity(
      ...
      // SRS Rule 1: the Sl. is auto-generated by the repository inside the
      // create transaction. 0 means "not yet assigned"; the persisted value is
      // preserved on update.
