/// ============================================================================
/// ফাইল: lib/core/services/local/local_settings_service.dart
/// স্তর: Core | মডিউল: Settings
/// উদ্দেশ্য: Local Settings Service সম্পর্কিত shared configuration, utility, service বা application-wide behavior প্রদান করে।
/// প্রধান অংশ: LocalSettingsService
